...
export class CTaskTab {
    ...
    //функция для получения таблицы проектов
    setDatatableProgect(progectdatatable) {
        this.viewProgectDatatable = progectdatatable
    }
    ...
    refreshTable() {
        var selected = this.viewProgectDatatable.getSelectedItem()
