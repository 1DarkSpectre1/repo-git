...
import (
	...
	_ "sample-project/app"
	controllers1 "sample-project/app/controllers"
...
func Register() {
	...
	revel.RegisterController((*controllers1.CAuth)(nil),
		[]*revel.MethodType{
			&revel.MethodType{
				Name: "Init",
				Args: []*revel.MethodArg{ 
	...
	revel.RegisterController((*controllers1.CBook)(nil),
		[]*revel.MethodType{
			&revel.MethodType{
				Name: "Init",
				Args: []*revel.MethodArg{ 
	...
	revel.RegisterController((*controllers1.CError)(nil),
		[]*revel.MethodType{
			&revel.MethodType{
				Name: "Unauthorized",
				Args: []*revel.MethodArg{ 
	...
	revel.RegisterController((*controllers1.CEvent)(nil),
		[]*revel.MethodType{
			&revel.MethodType{
				Name: "Init",
				Args: []*revel.MethodArg{ 
	...
	revel.RegisterController((*controllers1.CPosition)(nil),
		[]*revel.MethodType{
			&revel.MethodType{
				Name: "Init",
				Args: []*revel.MethodArg{ 
